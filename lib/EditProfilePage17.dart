...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<String?> _uploadImage(Uint8List bytes, String userId) async {
    final filePath = 'profile/profileimage/$userId.png';
  ...
  Widget build(BuildContext context) {
    ...
    } else if (_uploadedImagePath != null && _uploadedImagePath!.isNotEmpty) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            // Profile Image Section (แก้ไขได้)
            Container(
            ...
            // Form Section (แก้ไขได้แค่ ชื่อ กับ เบอร์โทรศัพท์)
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // อีเมล แสดงเป็นข้อความธรรมดา (ไม่แก้ไขได้)
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                  ...
                  // ที่อยู่ แสดงเป็นข้อความธรรมดา (ไม่แก้ไขได้)
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildPreviewItem('อีเมล:', _emailController.text),
                  _buildPreviewItem('ที่อยู่:', _addressController.text),
